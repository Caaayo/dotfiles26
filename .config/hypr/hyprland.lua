...
os.execute("hyprsunset &")

-- Run the schedule check at boot, then re-check every 30 minutes
os.execute("~/.local/bin/nightlight.sh && while true; do sleep 1800; ~/.local/bin/nightlight.sh; done &")
